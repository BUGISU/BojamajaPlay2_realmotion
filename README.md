...
|**버튼 매핑**     | **모션 인식 시작**     |
| ------------------------------------------------------------------------------------------------------- | -------------------------------------------- |-------------------------------------------- |
| <img src="Screenshots/293590147-7e2c5acd-0e02-4d69-b2fa-713eb976a7c7.png" width="200"/><br>   
| 손가락 제스처를 버튼 입력으로 매핑 (첫번째 버튼, 두번째 버튼, 뒤로가기 등) |제스처 인식 예시|
| <img src="Screenshots/293590148-7c3e4f92-e7f0-45cb-b734-e83618256053.gif" width="200"/><br> 
| 모션 인식기에 손을 올려 제스처 인식 시작                      |제스처 설명|
